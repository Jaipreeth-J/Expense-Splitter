  ...
  return (
    <div style={styles.page}>
      ...
      <section style={styles.section}>
        <h2 style={styles.sectionHeading}>Balances</h2>
        {loading ? <p>Loading balances...</p> : <BalancesView balances={members} currentUserId={user?.id} />}
      </section>

      <section style={styles.section}>
        <h2 style={styles.sectionHeading}>Settle up</h2>
        {loading ? (
          <p>Loading...</p>
        ) : (
          <SettlementsView
